#This imports modules and the scapy python library
from scapy.all import *
import random
import multiprocessing as mp

#This function generates a list of ports and combines it with a list of ports and randomly shuffles the final list
def configPortList():
...
#This function initializes a list and enters a loop to look for open ports 
#A packet is attempted to be created for each port and an item is selected from the list to assign the urgent pointer to the packet
...
#This code uses the try block and a condition for how the code is executed
#A message is displayed and a list of processes is created that is assigned to the attack function and the processes are started 
try:            
