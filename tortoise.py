...
Enter the target IPv4 address you wish to DoS, the amount of connections you wish to open with it, and how long you want to keep each connection open.'Ctrl+C' to quit.
"""
