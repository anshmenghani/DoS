...
try:            
    if __name__ == "__main__":
        print("This is Portal DDoS/DoS ([Distributed] Denial of Service) Software.\n\nDISCLAIMER: This software is for educational purposes ONLY. DDoS/DoS is an illegal activity and infringement of the law. The user(s) of this program may ONLY use this program to target machines where they have EXPLICIT permission to do so. Any violation of this procedure may result in legal action to be taken or other complications. The creator of this software and their affiliates are NOT responsible and do NOT claim ANY responsibility for the actions of the user(s) of this program. By using this software the user(s) agree(s) to the above terms and conditions.\n\nIMPORTANT: After beginning a DDoS/DoS attack, the ONLY way to completely stop the attack is to exit out of the program and COMPLETELY restart the machine.\n")
